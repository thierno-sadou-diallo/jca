@php
    ...
    $pageDescription = $description ?? ($page['intro'] ?? 'JCA accompagne les projets d immigration, de recrutement international, de cooperation et de developpement durable.');
